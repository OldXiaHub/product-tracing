...
public class Batch {
  ...
  public void setBatchStartjiduGeo(double batchStartjiduGeo) {
    this.batchStartjiduGeo = batchStartjiduGeo;
  }


  public double getBatchStartweiduGeo() {
    return batchStartweiduGeo;
  }

  public void setBatchStartweiduGeo(double batchStartweiduGeo) {
    this.batchStartweiduGeo = batchStartweiduGeo;
  }
